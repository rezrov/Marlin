...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu   RCF - interface config
  ...
  //#define LCD_TIMEOUT_TO_STATUS 15000   // (ms)
    ...
    #define BOOTSCREEN_TIMEOUT 2000       // (ms) Total Duration to display the boot screen(s)     RCF
 ...
 */
  ...
  #define PROBING_MARGIN_LEFT 24        // RCF - center probing on bed
  #define PROBING_MARGIN_RIGHT 0        // RCF - center probing on bed
